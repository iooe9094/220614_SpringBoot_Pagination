<template>
  <div id="app">
    <!-- sticky-top / sticky-bottom -> 메뉴 바 고정하는 부트스트랩 -->
    <nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark small">
      <a class="navbar-brand mr-5" href="#">
        <img src="@/assets/img/star.png" alt="" width="30" height="24" />
        Seok</a
      >
      <button
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown mr-4">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              ...
              <router-link to="/add-complains" class="dropdown-item">
                Add new Complain
              </router-link>
            </div>
          </li>
          ...
          <li class="nav-item dropdown mr-4">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <router-link to="/test2" class="dropdown-item">
                자유게시판 목록
              </router-link>
              <router-link to="/test2" class="dropdown-item">
                글쓰기
